...
#############################################################################################################################
############################   Part 1 - modifying the results (for external use)    ######################################### 
#############################################################################################################################
...
for i in pathology:
    ...
    AI_FN_after[i]= round((TP_before[i]-TP_before[i]*Target_AI[i])/Target_AI[i],0)
...
#############################################################################################################################
###########################   #Part 2 - calculations for our internal summaries)    ######################################### 
#############################################################################################################################
